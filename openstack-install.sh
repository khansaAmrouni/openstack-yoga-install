...
PASSWDS=( RABBIT_PASS KEYSTONE_DBPASS ADMIN_PASS MYUSER_PASS GLANCE_DBPASS GLANCE_PASS NOVA_DBPASS PLACEMENT_DBPASS NOVA_PASS PLACEMENT_PASS METADATA_SECRET NEUTRON_PASS NEUTRON_DBPASS NEUTRON_PASS CINDER_PASS CINDER_DBPASS)
